		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="whallocate/save.do" name="Form" id="Form" method="post">
						<input type="hidden" name="PK_SOBOOKS" id="PK_SOBOOKS" value="${pd.PK_SOBOOKS}"/>
						<div id="zhongxin" style="padding-top: 13px;">&nbsp;&nbsp;&nbsp;&nbsp;
							<td style="text-align: center;" colspan="10"><font size="6">仓库调拨</font></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<tr>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">调出仓:</td>
								<td id="tishi1">
									<select class="chosen-select form-control" name="OUTWH_ID" id="OUTWH_ID"  style="vertical-align:top;width:98%;" >
								...
								<td style="width:75px;text-align: right;padding-top: 13px;">调入仓:</td>
								<td id="tishi2">
									<select class="chosen-select form-control" name="INWH_ID" id="INWH_ID"  style="vertical-align:top;width:98%;" >
										<option value="">无</option>
										<c:forEach items="${warehouseList}" var="var">
											<option value="${var.WAREHOUSE_ID }" <c:if test="${var.WAREHOUSE_ID == pd.WAREHOUSE_ID }">selected</c:if>>${var.WHNAME }</option>
										</c:forEach>
...
// 	    });
		...
		function insertNewRow(GOOD_ID,GOODNAME,BARCODE,UNITNAME,GOODCODE,RPRICE,GOODTYPECODE,GOODSPECIF) {
			 //获取表格有多少行
	  ...
	  //计算总金额
		...
		function addgoods(){
			...
			diag.CancelEvent = function(){ //关闭事件
			    ...
			    if( GOOD_ID != null)
			    	insertNewRow(GOOD_ID,GOODNAME,BARCODE,UNITNAME,GOODCODE,RPRICE,GOODTYPECODE,GOODSPECIF);
				diag.close();
			};
			diag.show();
		}
