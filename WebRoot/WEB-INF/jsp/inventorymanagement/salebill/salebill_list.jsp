...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="salebill/list.do" method="post" name="Form" id="Form">
	...
	<script type="text/javascript">
		...
		//新增
		function add(){
			document.forms.actionForm.action="salebill/goAdd.do";
		...
		function fanshen(Id,ISSETTLEMENTED,BILLSTATUS){
			...
			bootbox.confirm("确定要反审吗?", function(result) {
				if(result) {
					...
					var url = "<%=basePath%>salebill/fanshen.do?SALEBILL_ID="+Id+"&tm="+new Date().getTime()+"&NOTE="+note;
					$.get(url,function(data){
						tosearch();
					});
				}
