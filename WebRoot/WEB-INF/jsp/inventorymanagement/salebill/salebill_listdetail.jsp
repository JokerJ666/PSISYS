...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="salebill/listdetail.do" method="post" name="Form" id="Form">
	...
	<script type="text/javascript">
		...
		function toExcel(){
			...
			window.location.href='<%=basePath%>salebill/excelDetail.do?lastStart='+lastStart+'&lastEnd='+lastEnd;
		}
