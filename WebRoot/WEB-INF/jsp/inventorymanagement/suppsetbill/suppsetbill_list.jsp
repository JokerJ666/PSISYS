...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="suppsetbill/list.do" method="post" name="Form" id="Form">
	...
	<script type="text/javascript">
		...
		function addsuppsetbill(){
			...
			siMenu('z290','lm280','添加供应商结算单',url);
		}
		...
		function del(Id,BILLSTATUS){
			...
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "<%=basePath%>suppsetbill/delete.do?SUPPSETBILL_ID="+Id+"&tm="+new Date().getTime();
