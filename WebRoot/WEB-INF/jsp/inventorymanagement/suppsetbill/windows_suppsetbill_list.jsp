...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<!-- 检索  -->
						<form action="supplier/windowsList.do" method="post" name="Form" id="Form">
							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											<td class='center'>
												<label class="pos-rel"><input type='radio' name="fhadmin" value="${var.SUPPLIER_ID }" onclick="setSupplier(this.value,'${var.SUPPLIERNAME }')" class="ace" /><span class="lbl"></span></label>
											</td>
	...
	<script type="text/javascript">
		...
		//选定客户
		function setSupplier(SUPPLIER_ID,SUPPLIERNAME){
			$("#SUPPLIER_ID").val(CUSTOMER_ID);
			$("#SUPPLIERNAME").val(CUATOMERNAME);
		}
