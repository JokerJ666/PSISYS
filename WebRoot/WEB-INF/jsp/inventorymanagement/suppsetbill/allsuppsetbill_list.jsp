			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="allsupplier/list.do" method="post" name="Form" id="Form">
...
<!-- 									<th class="center">跟踪记录</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<%-- <td class='center'><a style="cursor:pointer;" onclick="chaImg('${var.SUPPLIER_ID}')">[查看跟踪记录]</a></td>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-xs btn-success" title="查看" onclick="view('${var.SUPPLIER_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<li>
																<a style="cursor:pointer;" onclick="view('${var.SUPPLIER_ID}');" class="tooltip-success" data-rel="tooltip" title="查看">
																	<span class="green">
	...
	<script type="text/javascript">
		...
		function view(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="查看";
			 diag.URL = '<%=basePath%>supplier/goView.do?SUPPLIER_ID='+Id;
			 diag.Width = 450;
			 diag.Height = 500;
			 diag.Modal = false;			//有无遮罩窗口
			 diag. ShowMaxButton = true;	//最大化按钮
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>allsupllier/excel.do';
		}
	</script>
