		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="resalebill/edit.do" name="Form" id="Form" method="post">
						...
						<tr>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<td style="text-align: center;" colspan="10"><font size="6">修改退货单</font></td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
//	        $("formvalue").submit();
	  ...
	  function checkGoodsPriceAndNum(){
		...
		function addgoods(){
			...
			diag.Drag=true;
			diag.Title ="查看商品信息";
			diag.URL = '<%=basePath%>resalebill/goaddgoods.do?WAREHOUSE_ID=' + wh;
			diag.Width = 1000;
			diag.Height = 800;
