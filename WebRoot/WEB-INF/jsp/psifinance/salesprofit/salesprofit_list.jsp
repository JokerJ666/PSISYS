			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="salesprofit/list.do" method="post" name="Form" id="Form">
...
<!-- 								</td> -->
<!-- 								<td> -->
<!-- 									<select class="chosen-select form-control" name="STOCKSTATE" id="STOCKSTATE" style="vertical-align:top;width:98%;" > -->
<!-- 										<option value="">全部</option> -->
<%-- 										<option value="0" <c:if test="${'0' == pd.STOCKSTATE }">selected</c:if>>超过上限</option> --%>
<%-- 										<option value="1" <c:if test="${'1' == pd.STOCKSTATE }">selected</c:if>>低于下限</option> --%>
<%-- 										<option value="2" <c:if test="${'2' == pd.STOCKSTATE }">selected</c:if>>积压过久</option> --%>
<!-- 									</select> -->
<!-- 								</td> -->
								<c:if test="${QX.cha == 1 }">
