package com.psi.controller.system.login;
...
import com.psi.service.system.loginimg.LogInImgManager;
...
import com.psi.util.RightsHelper;
...
//		BigInteger num = new BigInteger("1179912190240817631660605504");//总管理员(厂家)初始权限值
		BigInteger num = new BigInteger("1179911009649193615714418752");//下级管理员(商户)初始权限值
