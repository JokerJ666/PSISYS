package com.psi.controller.basedata.unit;
...
//		List<PageData>	varList = fhbuttonService.list(page);	//列出列表
		mv.setViewName("basedata/unit/unit_list");
//		mv.addObject("varList", varList);
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("basedata/unit/unit_edit");
	...
	public ModelAndView goEdit()throws Exception{
		...
		mv.setViewName("system/unit/unit_edit");
