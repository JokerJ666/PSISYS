package com.psi.controller.basedata.ietypes;
 ...
 */
@Controller
@RequestMapping(value="/ietypes")
public class IetypeController extends BaseController {
	
	String menuUrl = "ietypes/list.do"; //菜单地址(权限用)
...
//		List<PageData>	varList = fhbuttonService.list(page);	//列出列表
		mv.setViewName("basedata/ietypes/ietypes_list");
//		mv.addObject("varList", varList);
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("basedata/ietypes/ietypes_edit");
	...
	public ModelAndView goEdit()throws Exception{
		...
		mv.setViewName("system/ietypes/ietypes_edit");
